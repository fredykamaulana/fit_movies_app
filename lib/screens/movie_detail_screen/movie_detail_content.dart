          ...
          children: [
            ...
            ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Padding(
                      padding: const EdgeInsets.all(8),
                      child: Text("- ${movieDetail.productionCountries[index].name}")
                  );
                }
            ),

            const SizedBox.square(dimension: 16),
            Text("Producer Companies:", style: Theme.of(context).textTheme.titleMedium),
            const SizedBox.square(dimension: 4),
            ListView.builder(
                primary: false,
                shrinkWrap: true,
                ...
                itemBuilder: (context, index) {
                  return Padding(
                      padding: const EdgeInsets.all(8),
                      child: Text("- ${movieDetail.productionCompanies[index].name}")
                  );
                })
          ],
        )
